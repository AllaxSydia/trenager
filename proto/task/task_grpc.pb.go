...
const (
	...
	TaskService_GetTasksByDifficulty_FullMethodName = "/task.TaskService/GetTasksByDifficulty"
)
...
type TaskServiceClient interface {
	...
	GetTasksByDifficulty(ctx context.Context, in *GetTasksByDifficultyRequest, opts ...grpc.CallOption) (*ListTasksResponse, error)
}
...
func (c *taskServiceClient) GetTasksByDifficulty(ctx context.Context, in *GetTasksByDifficultyRequest, opts ...grpc.CallOption) (*ListTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTasksResponse)
	err := c.cc.Invoke(ctx, TaskService_GetTasksByDifficulty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	GetTasksByDifficulty(context.Context, *GetTasksByDifficultyRequest) (*ListTasksResponse, error)
...
func (UnimplementedTaskServiceServer) GetTasksByDifficulty(context.Context, *GetTasksByDifficultyRequest) (*ListTasksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTasksByDifficulty not implemented")
}
...
func _TaskService_GetTasksByDifficulty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTasksByDifficultyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).GetTasksByDifficulty(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_GetTasksByDifficulty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).GetTasksByDifficulty(ctx, req.(*GetTasksByDifficultyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTasksByDifficulty",
			Handler:    _TaskService_GetTasksByDifficulty_Handler,
		},
	},
